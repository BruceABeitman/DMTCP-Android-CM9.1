...
#define JASSERT_CONTEXT(type,reason) Print('[').Print(getpid()).Print("] [").Print(gettid()).Print("] "type " at ").Print(JASSERT_FILE).Print(":" JASSERT_LINE " in ").Print(JASSERT_FUNC).Print("; REASON='" reason "'\n")
